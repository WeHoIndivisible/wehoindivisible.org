/* =====================================================
   WEST HOLLYWOOD–FAIRFAX INDIVISIBLE — Signup Form Handler
   js/signup-form.js
...
async function handleSignupSubmit(e) {
  ...
  try {
    ...
    showMsg(msgEl, 'error', 'Something went wrong. Email us at hello@wehofairfaxindivisible.org to sign up.');
  } finally {
